...
class ModelResolver
{
     ...
     */
    public function resolve(ModelRequirements $requirements, ModelConfig $modelConfig): ModelInterface
    {
        if ($this->model !== null) {
        ...
        if (empty($candidateMap)) {
            ...
            $capabilityValue = $primaryCapability !== false ? $primaryCapability->value : '';
